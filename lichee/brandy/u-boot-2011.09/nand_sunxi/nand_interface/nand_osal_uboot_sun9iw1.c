...
__s32 _get_ndfc_clk_v2(__u32 nand_index, __u32 *pdclk, __u32 *pcclk)
{
	...
	if (nand_index == 0) {
		NAND_Print("Reg 0x06000400: 0x%x\n", *(volatile __u32 *)(0x06000400));
		NAND_Print("Reg 0x06000404: 0x%x\n", *(volatile __u32 *)(0x06000404));
	} else {
		NAND_Print("Reg 0x06000408: 0x%x\n", *(volatile __u32 *)(0x06000400));
		NAND_Print("Reg 0x0600040C: 0x%x\n", *(volatile __u32 *)(0x06000404));
	}
	NAND_Print("NDFC%d:  sclk0(2*dclk): %d MHz   sclk1(cclk): %d MHz\n", nand_index, sclk0, sclk1);
...
__s32 _change_ndfc_clk_v1(__u32 nand_index, __u32 dclk_src_sel, __u32 dclk)
{
	...
	if (dclk == 0)
	{
		...
		NAND_Print("_change_ndfc_clk, close sclk0 and sclk1\n");
		return 0;
	}
...
__s32 _cfg_ndfc_gpio_v1(__u32 nand_index)
{
	...
	if (nand_index == 0) {
		...
		#if defined SUN8IW3P1  
		
		/* A21, A23 */
		NAND_Print("set gpio for A21/A23 platform...\n");
		
		*(volatile __u32 *)(0x01c20800 + 0x48) = 0x22222222;
		*(volatile __u32 *)(0x01c20800 + 0x4c) = 0x22222222;
		cfg = *(volatile __u32 *)(0x01c20800 + 0x50);
		cfg &= (~0xfff);
		cfg |= 0x222;
		*(volatile __u32 *)(0x01c20800 + 0x50) = cfg;
		...
		*(volatile __u32 *)(0x01c20800 + 0x54) = cfg;
		...
		NAND_Print("set gpio for A31/A31s platform...ch1\n");
