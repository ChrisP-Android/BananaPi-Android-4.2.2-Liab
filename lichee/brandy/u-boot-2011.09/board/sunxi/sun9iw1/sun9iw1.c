...
int dram_init(void)
{
	...
	script_parser_patch("dram_para", "lpddr2_type", &addr[2], 1);
	...
	script_parser_patch("dram_para", "dram_zq0pr", &addr[6], 1);
	script_parser_patch("dram_para", "dram_zq1pr", &addr[7], 1);
	script_parser_patch("dram_para", "dram_zq2pr", &addr[8], 1);

	script_parser_patch("dram_para", "dram_mr0", &addr[9], 1);
	script_parser_patch("dram_para", "dram_mr1", &addr[10], 1);
	script_parser_patch("dram_para", "dram_mr2", &addr[11], 1);
	script_parser_patch("dram_para", "dram_mr3", &addr[12], 1);

	script_parser_patch("dram_para", "dram_tpr0", &addr[13], 1);
	script_parser_patch("dram_para", "dram_tpr1", &addr[14], 1);
	script_parser_patch("dram_para", "dram_tpr2", &addr[15], 1);
	script_parser_patch("dram_para", "dram_tpr3", &addr[16], 1);
	script_parser_patch("dram_para", "dram_tpr4", &addr[17], 1);
	script_parser_patch("dram_para", "dram_tpr5", &addr[18], 1);
	script_parser_patch("dram_para", "dram_tpr6", &addr[19], 1);

	script_parser_patch("dram_para", "mx_dramtmg0", &addr[20], 1);
	script_parser_patch("dram_para", "mx_dramtmg1", &addr[21], 1);
	script_parser_patch("dram_para", "mx_dramtmg2", &addr[22], 1);
	script_parser_patch("dram_para", "mx_dramtmg3", &addr[23], 1);
	script_parser_patch("dram_para", "mx_dramtmg4", &addr[24], 1);
	script_parser_patch("dram_para", "mx_dramtmg5", &addr[25], 1);
	script_parser_patch("dram_para", "mx_dramtmg6", &addr[26], 1);

	script_parser_patch("dram_para", "mx_rfshtmg", &addr[27], 1);
