...
//        mKeypressSoundVolumeRawValue = prefs.getFloat(Settings.PREF_KEYPRESS_SOUND_VOLUME, -1.0f);
		mKeypressSoundVolumeRawValue = prefs.getFloat(Settings.PREF_KEYPRESS_SOUND_VOLUME, 0f);
...
//        final float volume = prefs.getFloat(Settings.PREF_KEYPRESS_SOUND_VOLUME, -1.0f);
		final float volume = prefs.getFloat(Settings.PREF_KEYPRESS_SOUND_VOLUME, 0f);
        if (volume >= 0) {
            return volume;
        }
