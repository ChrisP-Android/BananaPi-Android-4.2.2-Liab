...
typedef enum tag_KeyofGetParameter {
	PARAM_KEY_GET_UNKNOW = 0x00,
	PARAM_KEY_GET_AUDIO_CHANNEL = 0x01,
		PARAM_KEY_GET_SUB_INFO =0X02,
		PARAM_KEY_GET_AUDIO_INFO =0x03,
}KeyofGetParameter;
