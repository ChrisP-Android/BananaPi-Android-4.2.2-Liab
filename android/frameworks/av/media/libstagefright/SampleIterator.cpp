...
status_t SampleIterator::getChunkOffset(uint32_t chunk, off64_t *offset) {
    *offset = 0;
    ...
    #else
       memcpy(&offset32, (uint32_t *)(mTable->mBufChunkOffsetOffset + 8 + 4 * chunk), sizeof(offset32));
    ...
    #else
        memcpy(&offset64, (uint64_t *)(mTable->mBufChunkOffsetOffset + 8 + 8 * chunk), sizeof(offset64));
...
status_t SampleIterator::getSampleSizeDirect(
    ...
    *size = 0;
    ...
    switch (mTable->mSampleSizeFieldSize) {
        ...
        #else
            memcpy(size,  (size_t *)(mTable->mBufSampleSizeOffset + 12 + 4 * sampleIndex), sizeof(*size));
        ...
        #else
            memcpy(&x, (uint16_t *)(mTable->mBufSampleSizeOffset + 12 + 2 * sampleIndex), sizeof(x));
        ...
        #else
            memcpy(&x, (uint8_t *)(mTable->mBufSampleSizeOffset + 12 + sampleIndex), sizeof(x));
        ...
        #else
            memcpy(&x, (uint8_t *)(mTable->mBufSampleSizeOffset + 12 + sampleIndex / 2), sizeof(x));
