...
public class Tethering extends INetworkManagementEventObserver.Stub {
            ...
            if (up) {
                ...
                if (isUsb(iface)) {
                    ...
                    if(iface.equals("p2p0")) {
                        Log.d(TAG, "Ignore p2p0 down flags, nosense !!!!!");
                        return;
                    }
    ...
    class TetherMasterSM extends StateMachine {
		...
		int wifi_cheat_on = Settings.Secure.getInt(cr, Settings.Secure.WIFI_CHEAT_ON, 0);
                ...
                synchronized (mPublicSync) {
                    ...
                    for (Integer netType : mUpstreamIfaceTypes) {
                        ...
                        if ((info != null) && info.isConnected()) {
                        	LinkProperties linkProperties0 = null;
		                    try {
		                        linkProperties0 = mConnService.getLinkProperties(netType);
		                    } catch (RemoteException e) { }
		                    if (linkProperties0 != null) {
                        		iface = linkProperties0.getInterfaceName();                        		
                        	}
                        	if(iface != null){
