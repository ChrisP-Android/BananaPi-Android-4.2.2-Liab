...
public class WifiP2pManager {
    ...
    /* set GroupOnwer psk */
    /** @hide */
    public static final int SET_GO_PSK                              = BASE + 67;
    /** @hide */
    public static final int SET_GO_PSK_FAILED                       = BASE + 68;
    /** @hide */
    public static final int SET_GO_PSK_SUCCEEDED                    = BASE + 69;
        ...
        class P2pHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                switch (message.what) {
                    ...
                    case WifiP2pManager.SET_GO_PSK_FAILED:
                        if (listener != null) {
                    ...
                    case WifiP2pManager.SET_GO_PSK_SUCCEEDED:
                        if (listener != null) {
   ...
   /**
     ...
     * @param listener for callback when group info is available. Can be null.
     */
    public void setGroupOwnerPsk(Channel c, String psk, ActionListener listener) {
        checkChannel(c);
        WifiP2pDevice d = new WifiP2pDevice();
        d.deviceName = psk;
        c.mAsyncChannel.sendMessage(SET_GO_PSK, 0, c.putListener(listener), d);
    }
