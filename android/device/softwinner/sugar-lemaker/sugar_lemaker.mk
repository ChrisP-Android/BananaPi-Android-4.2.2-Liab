...
DEVICE_PACKAGE_OVERLAYS := device/softwinner/sugar-lemaker/overlay

PRODUCT_COPY_FILES += \
	device/softwinner/sugar-lemaker/modules/modules/nand.ko:root/nand.ko \
	device/softwinner/sugar-lemaker/modules/modules/sun7i-ir.ko:root/sun7i-ir.ko \
	#device/softwinner/sugar-lemaker/modules/modules/disp.ko:root/disp.ko \
	#device/softwinner/sugar-lemaker/modules/modules/lcd.ko:root/lcd.ko \
	#device/softwinner/sugar-lemaker/modules/modules/hdmi.ko:root/hdmi.ko \

PRODUCT_COPY_FILES += \
	device/softwinner/sugar-lemaker/kernel:kernel \
	device/softwinner/sugar-lemaker/recovery.fstab:recovery.fstab \
	frameworks/base/data/etc/android.hardware.wifi.direct.xml:system/etc/permissions/android.hardware.wifi.direct.xml \

PRODUCT_COPY_FILES += \
	device/softwinner/sugar-lemaker/ueventd.sun7i.rc:root/ueventd.sun7i.rc \
	device/softwinner/sugar-lemaker/init.sun7i.rc:root/init.sun7i.rc \
	device/softwinner/sugar-lemaker/init.sun7i.usb.rc:root/init.sun7i.usb.rc \
	device/softwinner/sugar-lemaker/init.recovery.sun7i.rc:root/init.recovery.sun7i.rc \
	device/softwinner/sugar-lemaker/needfix.rle:root/needfix.rle \
	device/softwinner/sugar-lemaker/camera.cfg:system/etc/camera.cfg \
	device/softwinner/sugar-lemaker/media_profiles.xml:system/etc/media_profiles.xml \
	frameworks/native/data/etc/android.hardware.camera.xml:system/etc/permissions/android.hardware.camera.xml \
        frameworks/native/data/etc/tablet_core_hardware.xml:system/etc/permissions/tablet_core_hardware.xml

#input device config
PRODUCT_COPY_FILES += \
	device/softwinner/sugar-lemaker/sw-keyboard.kl:system/usr/keylayout/sw-keyboard.kl \
	device/softwinner/sugar-lemaker/sun7i-ir.kl:system/usr/keylayout/sun7i-ir.kl \
	device/softwinner/sugar-lemaker/tp.idc:system/usr/idc/tp.idc \
	device/softwinner/sugar-lemaker/gsensor.cfg:system/usr/gsensor.cfg

PRODUCT_COPY_FILES += \
	device/softwinner/sugar-lemaker/initlogo.rle:root/initlogo.rle

PRODUCT_COPY_FILES += \
	device/softwinner/sugar-lemaker/vold.fstab:system/etc/vold.fstab
...
$(call inherit-product-if-exists, device/softwinner/sugar-lemaker/modules/modules.mk)

PRODUCT_CHARACTERISTICS := tablet

# Overrides
PRODUCT_BRAND  := softwinners
PRODUCT_NAME   := sugar_lemaker
PRODUCT_DEVICE := sugar-lemaker
PRODUCT_MODEL  := LeMaker-BP
